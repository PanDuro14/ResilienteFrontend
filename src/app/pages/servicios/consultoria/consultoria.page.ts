...
export class ConsultoriaPage implements OnInit {
  ...
  public cursos = [
    ...
    { titulo: "Manejo del Estrés Laboral", desc: "Domina las técnicas para identificar, comprender y gestionar el estrés laboral. ¡Mejora tu bienestar emocional y rendimiento profesional!", img: "https://ionicframework.com/docs/img/demos/card-media.png", link: "assets/img/cursos/manejo-del-estres-laboral.webp" },
